...
export default function Register() {
  const [form, setForm] = useState({ username: "", email: "", password: "", admin_secret_key: "" });
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 w-full max-w-md p-8">
        ...
        <p className="text-gray-500 text-sm mb-6">Register as a Admin</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          {[
            ...
            { key: "admin_secret_key", label: "Admin Secret Key", type: "password", placeholder: "Required Admin Secret Key" },
